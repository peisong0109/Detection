package com.example.acousens.settingbar;
...
public class SettingBar extends LinearLayout implements View.OnClickListener {
    ...
    private SwitchButton rightButton;
    ...
    private void initViews(Context context) {
        ...
        this.rightButton = (SwitchButton)findViewById(R.id.right_button);
    ...
    public void setupModel(SettingBarModel model) {
        ...
        if (mModel.getRightButton() != 0 ) {
            setRightButton(mModel.getRightButton());
        }
...
//        this.rightButton.setImageResource(resId);
        this.mModel.setRightButton(resId);
    }
...
//        this.mModel.setRightButton(resId);
    ...
    public void setRightButtonVisibility(boolean visible) {
        this.rightButton.setVisibility(visible ? View.VISIBLE : View.GONE);
    }
